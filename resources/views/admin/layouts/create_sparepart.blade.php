        ...
        <div class="card card-primary">
            ...
            <form action="{{ route('admin.sparepart.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="namaSparepartInput" style="max-width: 400px;">
                                @error('title')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="descriptionTextarea" class="form-label">Deskripsi Sparepart</label>
                                <textarea name="description" id="descriptionTextarea" class="form-control" style="max-width: 400px;" cols="40" rows="4"></textarea>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        <label for="imageInput">Foto Sparepart</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="bengkel_id" id="bengkelSelect" class="form-control" style="max-width: 400px;">
                            @foreach($bengkels as $bengkel)
                                <option value="{{ $bengkel->id }}">{{ $bengkel->title }}</option>
                            @endforeach
                        </select>
                        @error('bengkel_id')
                            <span class="text-danger">{{ $message }}</span>
