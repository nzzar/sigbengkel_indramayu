                    ...
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center mb-3">
                            ...
                            <div class="ms-auto d-flex">
                                <a href="{{ route('admin.sparepart.create') }}" type="button"
                                ...
                                <tbody>
                                    @foreach ($sparepart as $s)
                                        <tr>
                                            ...
                                            <td>{{ $s->title }}</td>
                                            <td>{{ $s->description }}</td>
                                            <td><img src="{{ asset('storage/photo-user/' . $s->image) }}"
                                                    class="img-fluid" width="100"></td>
                                            <td>
                                                <a href="{{ route('admin.sparepart.edit',['id' => $s->id]) }}" class="btn btn-warning"><i
                                                        class="fas fa-edit"></i>Edit</a>
                                                <a data-toggle="modal" data-target="#modal-hapus{{ $s->id }}" class="btn btn-danger"><i
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        <form
                                                            action="{{ route('admin.sparepart.delete', ['id' => $s->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
